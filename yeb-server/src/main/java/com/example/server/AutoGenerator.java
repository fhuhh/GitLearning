...
//        首先还是需要配置
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/yeb?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai",
                ...
                .globalConfig(builder -> {
                    builder.author("dys")
                            .outputDir(System.getProperty("user.dir")+"/yeb-server/src/main/java")
                            .disableOpenDir()
                            .enableSwagger()
                ...
                .packageConfig(builder -> {
                    builder.parent("com.example")
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.xml,System.getProperty("user.dir")+"/yeb-server/src/main/resources/mapper"));
                })
